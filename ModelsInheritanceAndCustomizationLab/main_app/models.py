...
from main_app.choices import SpecializationChoices
...
class ZooKeeper(Employee):
    specialty = models.CharField(max_length=10, choices=SpecializationChoices.choices)
    managed_animals = models.ManyToManyField(to=Animal)

    def clean(self):

        valid_choices = [choice[0] for choice in SpecializationChoices.choices]
