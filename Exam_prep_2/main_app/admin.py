...
class DirectorAdmin(admin.ModelAdmin):
    ...
    search_help_text = "Search directors by full name or nationality."
...
class ActorAdmin(admin.ModelAdmin):
    ...
    search_help_text = "Search actors by full name."
...
class MovieAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('last_updated',)
    search_help_text = "Search movies by title or director's full name."
